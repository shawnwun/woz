...
function getFeedback() {
   ...
   // var Q4 = $("input[name='Q4']:checked").val();
    ...
    xmlFeedback += "<question id=\"0\" name=\"Did the systems complete the task ?\">" + Q0 + "</question>\n";
    xmlFeedback += "<question id=\"1\" name=\"Which system is more natural ?\">" + Q1 + "</question>\n";
    xmlFeedback += "<question id=\"2\" name=\"Which system understand you more ?\">"+ Q2 + "</question>\n";
    xmlFeedback += "<question id=\"3\" name=\"Which system you prefer to talk to ?\">"+ Q3 + "</question>\n";
    xmlFeedback += "<question id=\"4\" name=\"In general, which system performs better ?\">"+ Q4 + "</question>\n";
